...
sendSmtpEmail.sender = { email: 'hriddhiranjansrivastav10b@gmail.com', name: 'WasteZero' }
      ...
      `
        ...
        <head>
          <style>
            ...
            .otp-box { background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border: 2px dashed #10b981; border-radius: 8px; padding: 20px; text-align: center; margin: 30px 0; }
            .otp-code { font-size: 36px; font-weight: bold; color: #059669; letter-spacing: 8px; margin: 10px 0; }
            .info { background: #f9fafb; border-left: 4px solid #10b981; padding: 15px; margin: 20px 0; border-radius: 4px; }
            .footer { background: #f9fafb; padding: 20px; text-align: center; color: #666; font-size: 14px; border-top: 1px solid #e5e7eb; }
          </style>
        </head>
        <body>
          <div class="container">
            <div class="header"><h1>&#9851; WasteZero</h1></div>
            <div class="content">
              <h2>Hello ${name}!</h2>
              <p>${message}</p>
              ...
              <p style="color: #6b7280; margin-top: 30px;">If you have any questions, feel free to contact our support team.</p>
            </div>
            <div class="footer">
              <p style="margin: 0;"><strong>Join the movement for a cleaner tomorrow &#127757;</strong></p>
              <p style="margin: 10px 0 0 0;">&copy; ${new Date().getFullYear()} WasteZero. All rights reserved.</p>
            </div>
          </div>
        </body>
        </html>
